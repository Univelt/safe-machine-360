  ...
  return (
    <AuthenticatedShell variant="client">
      <div className="dashboard record-page">
        <section className="page-heading"><div><span className="eyebrow">NR-12</span><h1>Cadastro das máquinas e equipamentos</h1><p>Campos da apresentação: equipamento, série, patrimônio/TAG, documento, revisão, setor, ano, fabricante, capacidade, categoria, HRN e limites.</p></div><Link className="button secondary" href="/cliente/maquinas">Voltar</Link></section>
        <form className="panel record-form" action={createMachineAction}>
          ...
          <label>Ano de fabricação<input name="year" type="number" required /></label>
          ...
          <label>HRN atual<input name="hrnCurrent" type="number" required defaultValue={80} /></label>
          <label>HRN residual<input name="hrnResidual" type="number" /></label>
          ...
          <label className="full">Habilidades dos operadores<textarea name="operatorSkills" rows={2} /></label>
          <label className="full">Habilidades da manutenção mecânica<textarea name="mechMaintenanceSkills" rows={2} /></label>
          <label className="full">Habilidades da manutenção elétrica<textarea name="elecMaintenanceSkills" rows={2} /></label>
          <label className="full">Limite do equipamento<textarea name="equipmentLimits" rows={3} /></label>
